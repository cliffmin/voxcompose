...
/**
 * Represents VoxCompose capabilities for plugin negotiation. This allows VoxCompose to communicate
 * its requirements and preferences to the calling application (e.g., macos-ptt-dictation).
 */
public class Capabilities {
  ...
  public static class Activation {
    ...
    public static class LongForm {
      ...
      public void setOptimalDuration(int optimalDuration) {
  ...
  public static class Learning {
    ...
    public int getCorrectionsLearned() {
      return correctionsLearned;
    }

    public void setCorrectionsLearned(int count) {
      this.correctionsLearned = count;
    }
  ...
  public static class Preferences {
    ...
    public String getWhisperImpl() {
      return whisperImpl;
    }

    public void setWhisperImpl(String impl) {
      this.whisperImpl = impl;
    }

    public String getRefineAggressiveness() {
      return refineAggressiveness;
    }

    public void setRefineAggressiveness(String level) {
      this.refineAggressiveness = level;
    }
  }
  ...
  public static Capabilities loadFromProfile() {
    ...
    if (profile != null) {
      ...
      caps.learning.lastUpdated = LocalDateTime.now().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME);

      // Log for debugging
      System.err.println(
          "INFO: Loaded profile with threshold: "
              + profile.getMinDurationForRefinement()
              + "s, "
              + profile.getCorrectionsCount()
              + " corrections");
    } else {
